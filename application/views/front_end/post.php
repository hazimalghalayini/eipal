            ...
            <div id="contentWrapper">
                <div class="page-title title-1">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx animated fadeInLeft" data-animate="fadeInLeft">تفاصيل <span>الخبر</span></h1>
                                <div class="breadcrumbs main-bg fx animated fadeInUp" data-animate="fadeInUp">
                                    <span class="bold">أنت داخل:</span><a href="#">الرئيسية</a><span class="line-separate">/</span><span>تفاصيل الخبر</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sectionWrapper">
                    <div class="container">
                        <div class="row">
                            <div class="cell-9">
                                <!-- Post Details Start -->
                                <?php $this->load->view('front_end/includes/post_details'); ?>
                                <!-- Post Details End --> 
                            </div>
