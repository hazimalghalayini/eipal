...
<html>
    <head>
        ...
        <title><?= $this->config->item('website_name').'-'.'نتائج البحث'?></title>
            ...
            <div id="contentWrapper">
                <div class="page-title title-1">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx animated fadeInLeft" data-animate="fadeInLeft">نتائج <span>البحث</span></h1>
                                <div class="breadcrumbs main-bg fx animated fadeInUp" data-animate="fadeInUp">
                                    <span class="bold">أنت داخل:</span><a href="#">الرئيسية</a><span class="line-separate">/</span><span>كل الأخبار</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="cell-9 blog-thumbs">
                                <!-- All Posts Start -->
                                    <?php $this->load->view('front_end/includes/search_result'); ?>
                                    <!-- All Posts End -->
                            </div>
