...
<html>
    <head>
        ...
        <title><?= $this->config->item('website_name').'-'.'الأخبار'?></title>
            ...
            <div id="contentWrapper">
                <div class="page-title title-1">
                    <div class="container">
                        <div class="row">
                            <div class="cell-12">
                                <h1 class="fx animated fadeInLeft" data-animate="fadeInLeft">جميع <span>الأخبار</span></h1>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="cell-9 blog-thumbs">
                                <!-- All Posts Start -->
                                    <?php $this->load->view('front_end/includes/all_posts'); ?>
                                    <!-- All Posts End -->
                            </div>
