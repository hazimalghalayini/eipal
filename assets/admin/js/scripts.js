var App = function() {
    ...
    var handleStyler = function() {
        ...
        var setColor = function(color, url) {
            var base_url = $('#theme-change .colors').attr('theme-url');
            $('#style_color').attr("href", base_url + "/assets/admin/css/" + color + ".css");
    ...
    var handleDateTimePickers = function() {
        ...
        $('#form-date-range').daterangepicker({
            ranges: {
                ...
                'أخر 7 أيام': [Date.today().add({
                        days: -6
                    }), 'today'],
                'أخر 30 يوم': [Date.today().add({
                        days: -29
                    }), 'today'],
                'الشهر الحالي': [Date.today().moveToFirstDayOfMonth(), Date.today().moveToLastDayOfMonth()],
                'الشهر السابق': [Date.today().moveToFirstDayOfMonth().add({
                        months: -1
                    }), Date.today().moveToFirstDayOfMonth().add({
                        days: -1
                    })]
